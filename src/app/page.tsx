...
export default async function HomePage() {
  ...
  return (
    ...
    <section className="flex flex-col justify-center min-h-screen pb-[100px]" style={{ paddingTop: "100px", paddingLeft: "var(--site-padding-x)", paddingRight: "var(--site-padding-x)" }}>
      <div className="grid grid-cols-1 md:grid-cols-[1.2fr_0.8fr] items-center gap-[6vw] mb-[12vh]">
        ...
        <div className="fade-in relative w-full aspect-[4/5] overflow-hidden border border-white/5">
          <img
            ...
            alt="Muthiri Artwork"
            className="hero-image w-full h-full object-cover contrast-[105%]"
          />
        </div>
      </div>
